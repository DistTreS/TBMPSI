...
<body>
        <div class="container rounded shadow-lg px-4 py-5 mt-5" style="max-width: 420px">
            <h1 class="text-center mb-4">ABSENSI & KEGIATAN
            <img src="source\img\PPSDM.png" class="logo" alt="logo PPSDM">
            </h1>
