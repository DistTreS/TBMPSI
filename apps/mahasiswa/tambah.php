<?php
    ...
    if (isset($_POST['tambah_mahasiswa'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $pembina_magang=input($_POST["pembina_magang"]);
            ...
            if (!empty($foto)){
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    ...
                    $sql="insert into tbl_mahasiswa (kode_mahasiswa,nama,universitas,jurusan,nim,mulai_magang,akhir_magang,pembina_magang,alamat,no_telp,foto) values
                    ('$kode_mahasiswa','$nama','$universitas','$jurusan','$nim','$mulai_magang','$akhir_magang','$pembina_magang','$alamat','$no_telp','$foto')";
                }
            }else {
...
<form action="apps/mahasiswa/tambah.php" method="post" enctype="multipart/form-data">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <select name="universitas" class="form-control" required>
                    ...
                    <?php foreach ($univ as $universitas): ?>
                        <option value="<?php echo $universitas; ?>"><?php echo $universitas; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <label>Pembina Magang:</label>
                <input type="text" name="pembina_magang" class="form-control" placeholder="Masukan Nama Pembina Magang Mahasiswa" required>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
