    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input type="text" name="pembina_magang" class="form-control" value="<?php echo $data['pembina_magang'];?>" placeholder="Masukan Nama Pembina Magang Mahasiswa" required>
            </div>
        </div>
