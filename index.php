...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <div>
    <img src="apps/pengaturan/logo/logo.png" 
        class="logo-ka" alt="ini logo" 
        style="width: 100px; margin-left: 30px;margin-top: 30px; display: block; margin-right: auto; margin-left: auto;">
    </div>
...
<div class="divider"></div>
    ...
    <!-- Menu Admin -->
        <?php if ($_SESSION["level"]=="Admin" or $_SESSION['level']=='admin'): ?>
            <li><a href="index.php?page=mahasiswa" id="mahasiswa"><em class="fa fa-users">&nbsp;</em> Kelola Mahasiswa</a></li>
            <li><a href="index.php?page=data_absensi" id="data_absensi"><em class="fa fa-calendar">&nbsp;</em> Kelola Absensi</a></li>
            <li><a href="index.php?page=data_kegiatan" id="kegiatan"><em class="fa fa-book">&nbsp;</em> Kelola Kegiatan</a></li>
            <li><a href="index.php?page=admin" id="admin"><em class="fa fa-book">&nbsp;</em> Admin</a></li>
            <li><a href="index.php?page=pengaturan" id="pengaturan"><em class="fa fa-gear">&nbsp;</em>Profil Instansi</a></li>
            <?php endif; ?>
    <!-- Menu Admin -->
    <!-- Menu Mahasiswa -->
            <?php  if ($_SESSION["level"]=="Mahasiswa" or $_SESSION["level"]=="mahasiswa"): ?>
...
<script>
  ...
  // Update tombol berdasarkan tema saat ini
